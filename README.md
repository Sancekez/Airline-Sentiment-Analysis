...
### Шаг 3. Обучение BERT-модели (рекомендуется)
...
> ⏱ Время обучения:
> - На CPU: **~30 минут — 2.5 часа** (зависит от процессора)
...
Если файл существует — BERT готов к использованию, переходите к шагу 4.
